...
Expose l'API UrBackup via FastAPI avec documentation Swagger personnalisée.
"""
...
app = FastAPI(
    title="UrBackup REST API Proxy",
    docs_url=None,  # Désactive la route /docs par défaut pour la remplacer
    redoc_url=None
)

# === Swagger UI customisation ===

# Monte le dossier 'static' pour servir le logo
...
async def custom_swagger_ui_html():
    ...
    # Injection correcte de l'URL OpenAPI dans le template (guillemets inclus)
